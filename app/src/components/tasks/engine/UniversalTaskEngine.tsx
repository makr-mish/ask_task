...
> = {
  ...
  "yandex-uslugi": {
    title: "Дополнительная информация",
    text: "Перед выполнением задания убедитесь, что вы авторизованы в Яндексе и открыли правильную карточку исполнителя.",
  },

  "google-maps": {
    title: "Дополнительная информация",
    text: "Перед публикацией отзыва убедитесь, что вы вошли в нужный Google-аккаунт и открыли правильную карточку компании.",
  },
